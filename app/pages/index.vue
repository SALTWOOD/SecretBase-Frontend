...
const bannerDisplayMode = computed(() => homeSettings.value?.bannerDisplayMode || "full");
  ...
  <main class="min-h-screen bg-neutral-50 dark:bg-neutral-950">
    ...
    <div :class="['py-12 md:py-20', isFullScreenMode ? '' : 'pt-12']">
      <UContainer :id="isFullScreenMode ? 'articles' : undefined">
        ...
        <template v-else>
          <div v-if="articles?.length" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-20">
            <article
